...
DEFINE_FIELD_U(_primitiveValue,   CustomAttributeValue,           m_rawValue)
DEFINE_FIELD_U(_arrayValue,       CustomAttributeValue,           m_value)
DEFINE_FIELD_U(_stringValue,      CustomAttributeValue,           m_enumOrTypeName)
DEFINE_FIELD_U(_type,             CustomAttributeValue,           m_type)
...
DEFINE_FIELD_U(_type,             CustomAttributeArgument,        m_type)
DEFINE_FIELD_U(_encodedArgument,  CustomAttributeArgument,        m_value)
...
DEFINE_FIELD_U(_slots,                  LoaderAllocatorObject,      m_pSlots)
DEFINE_FIELD_U(_slotsUsed,              LoaderAllocatorObject,      m_slotsUsed)
...
DEFINE_FIELD_U(_nativeLoaderAllocator,  LoaderAllocatorScoutObject,      m_nativeLoaderAllocator)
